 ...
 * @author muhammad
 */
@ManagedBean(name="correspondenceBank")
@RequestScoped
public class CorrespondenceBank implements Serializable{
...
//********************************************Post Construct
   ...
   public void init() {
   	...
   	newGLheadLetteroptions = new LinkedHashMap<String, String>();
        ...
        for (int i = 1; i<11; i++){
            newGLheadNumberoptions.put(String.format("%02d", i),String.format("%02d", i));
        }
...
public void onChanges(){
    ...
    String stringGLhead = String.valueOf(checkrequest.getParameter("GLhead:tabViewMVS:GLheadLetter_input"));
